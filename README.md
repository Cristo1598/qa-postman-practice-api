...
Práctica de API Testing manual con Postman, cubriendo operaciones CRUD completas (Create, Read, Update, Delete) sobre la API pública reqres.in, incluyendo validación de casos positivos y negativos.
